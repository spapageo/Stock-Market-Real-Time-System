...
marketSim: marketSim.c market.c stop.c limit.c marketSim.h market.h stop.h limit.h
	gcc -Wall -Wextra -O3 -m64 -mtune=native marketSim.c market.c stop.c stoplimit.c limit.c -lpthread -o marketSim

clang: marketSim.c market.c stop.c limit.c marketSim.h market.h stop.h limit.h
	clang -Wall -Wextra -O4 marketSim.c market.c stop.c stoplimit.c limit.c -lpthread -o marketSim

debug: marketSim.c market.c stop.c limit.c marketSim.h market.h stop.h limit.h
	gcc -Wall -Wextra -g3 marketSim.c market.c stop.c stoplimit.c limit.c -lpthread -o marketSim
